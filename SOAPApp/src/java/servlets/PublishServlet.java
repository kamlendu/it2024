...
import pcl.PublishBean;
import pcl.PublishBeanService;
   ...
   // @EJB PublishBeanLocal pbl;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           // pbl.addCustomer("Sukesh", "Gajera");
           //pbl.removeCustomer(10);
           
           //pbl.addAddressToCustomer("M-451", "Vadodara", "Gujarat", "387631", 14);
           //pbl.addAddressToCustomer("Downing street", "London", "Brampton", "812345", 14);
           
          // pbl.removeAddressFromCustomer(6, 13);
           //pbl.removeAddressFromCustomer(7, 13);
           ...
           pbl.addSubscriptionsToCustomer(14, sids);
        //pbl.removeSubscriptionsToCustomer(13, sids);
