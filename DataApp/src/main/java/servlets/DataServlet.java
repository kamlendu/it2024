...
public class DataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           // dbl.addBook("Men are from Mars", "S. Preety", "Thomson", "A motivational best seller");
            
          //  dbl.updateBook(383,"Men are from Mars", "Pablo Minhas", "TMH", "A motivational best seller");
            
        //  dbl.removeBook(383);
            
            Collection<BookMaster> books = dbl.getAllBooks();
            
         // Collection<BookMaster> books = dbl.getBooksByPublisher("TMH");
         ...
         for(BookMaster b : books)
            ...
            out.println("</table><h1>Servlet DataServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
